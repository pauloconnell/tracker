    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-32 pb-24 text-center">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-10">
          mainTracker helps you stay ahead of repairs, plan maintenance, and keep your car running like new.
          Smart reminders, clean history logs, and a dashboard built for real drivers.
        </p>

        <a
          href="/api/auth/login"
          className="inline-block px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white text-lg font-semibold rounded-lg shadow-lg transition"
        >
          Get Started
        </a>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20 grid md:grid-cols-3 gap-12">
        <div className="bg-gray-800/40 p-8 rounded-xl border border-gray-700">
          ...
          <p className="text-gray-400">
            Automatic notifications for oil changes, tire rotations, inspections, and more.
          </p>
        </div>
        ...
        <div className="bg-gray-800/40 p-8 rounded-xl border border-gray-700">
          ...
          <p className="text-gray-400">
            Keep a clean, searchable log of every repair, upgrade, and maintenance event.
          </p>
        </div>
      ...
      <section className="text-center py-20 bg-gray-900 border-t border-gray-800">
        <h2 className="text-3xl font-bold mb-6">Ready to take control of your maintenance?</h2>
        <a
          href="/api/auth/login"
